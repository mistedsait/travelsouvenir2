...
@Composable
fun FirstGuidePage(navController: NavHostController) {
    ...
    Box(
        ...
        Column(
            ...
            Text(
                text = "Start by taking photos of your favorite places. Use our app's camera feature to save your memories directly to your travel album.\uD83C\uDF0D\uD83D\uDCF8",
                fontSize = 14.sp,
            ...
            PrettyButton(
                text = "Next",
                onClick = {navController.navigate(TravelScreen.SecondPage.route)}
            )
        }
    }
}
